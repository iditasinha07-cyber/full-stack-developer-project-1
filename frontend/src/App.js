      ...
      <div className="main">
        ...
        {tab==="dashboard" && (
          <div>
            ...
            <div className="card">
              <div className="card-title">🏢 Department Statistics</div>
              <table>
                ...
                <tbody>
                  {deptStats.map((d,i)=>(
                    <tr key={i}>
                      ...
                      <td>₹{Number(d.avg_salary||0).toLocaleString("en-IN")}</td>
        ...
        {tab==="employees" && (
          <div>
            ...
            <div className="card">
              ...
              <table>
                <thead><tr><th>Employee</th><th>Designation</th><th>Department</th><th>Phone</th><th>Salary</th><th>Role</th><th>Actions</th></tr></thead>
                <tbody>
                  {employees.map(emp=>(
                    <tr key={emp.id}>
                      <td>
                      ...
                      <td><div className="actions-row"><button className="btn btn-edit" onClick={()=>setEditEmp(emp)}>Edit</button><button className="btn btn-danger" onClick={()=>deleteEmployee(emp.id)}>Delete</button></div></td>
                    </tr>
                  ))}
                </tbody>
              </table>
                  ...
                  <tbody>
                    {leaves.map(l=>(
                      <tr key={l.id}>
                        ...
                        <td>{l.status==="Pending"&&<div className="actions-row"><button className="btn btn-success" onClick={()=>handleLeaveAction(l.id,"Approved")}>Approve</button><button className="btn btn-danger" onClick={()=>handleLeaveAction(l.id,"Rejected")}>Reject</button></div>}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
        ...
        {tab==="assets" && (
          <div>
            ...
            <div className="card">
              ...
              <table>
                <thead><tr><th>Asset</th><th>Type</th><th>Employee</th><th>Allocated date</th><th>Status</th><th>Actions</th></tr></thead>
                <tbody>
                  {allocations.map(a=>(
                    <tr key={a.id}>
                      <td>{a.asset_name}</td>
                      ...
                      <td>{a.status==="Allocated"&&<button className="btn btn-success" onClick={()=>returnAsset(a.id)}>Return</button>}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
